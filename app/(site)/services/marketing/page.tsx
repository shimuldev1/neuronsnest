...
const SEO = () => {
  ...
  const getServiceTitle: string =
    "What You Get from Marketing AI & CRM Solutions";
  ...
  return (
    <div>
      <Head>
        <title>AI-Driven Marketing and CRM - NeuronsNest</title>
        <meta
          name="description"
          content="Unlock the power of AI-driven marketing and CRM with NeuronsNest. Our intelligent automation solutions help businesses personalize customer interactions, automate lead nurturing, and optimize campaigns to boost conversions and customer loyalty. Experience scalable growth with AI-powered customer insights and marketing automation."
        />
        <meta
          name="keywords"
          content="AI marketing, AI CRM, marketing automation, customer relationship management, lead nurturing, predictive analytics, customer engagement, AI-powered marketing, CRM automation, personalized marketing, campaign optimization"
        />
